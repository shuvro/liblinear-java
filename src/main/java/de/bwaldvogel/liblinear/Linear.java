 ...
 *
 * <p>The usage should be pretty similar to the C version of <code>liblinear</code>.</p>
 * <p>Please consider reading the <code>README</code> file of <code>liblinear</code>.</p>
 *
